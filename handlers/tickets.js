...
const setupSchema = require(`${process.cwd()}/modelos/setup`);
        ...
        try {
            ...
            channel.send({
                embeds: [new Discord.MessageEmbed()
                    ...
                    .setDescription(`Bienvenido al soporte ${interaction.member}\nExplica detallademente tu problema y en breve seras atendido por un staff.`)
            ...
            await interaction.editReply({
                ...
                .setDescription(`**Ticket creado en ${channel}**`)
                ], ephemeral: true
            })
            ...
            switch (interaction.customId) {
                case "cerrar_ticket":{
                    ...
                    const verificar = await interaction.channel.send({
                        embeds: [new Discord.MessageEmbed()
                        .setTitle(`¿Estas seguro de que quieres cerrar el ticket?`)
                        .setColor("GREEN")
                        ],
                        components: [new Discord.MessageActionRow().addComponents(
                            new Discord.MessageButton().setLabel("Estoy seguro").setStyle("SUCCESS").setCustomId("Estoy seguro").setEmoji("✅")
                        )]
                    });
                    ...
                    collector.on("end", (collected) => {
                        ...
                        if(collected && collected.first() && collected.first().customId){
                            ...
                            verificar.edit({
                                components: [new Discord.MessageActionRow().addComponents(
                                    new Discord.MessageButton().setLabel("Estoy seguro").setStyle("SUCCESS").setCustomId("seguro").setEmoji("✅").setDisabled(true)
                                )]
                            })
                        } else {
                            verificar.edit({
                ...
                case "borrar_ticket": {
                    ...
                    const verificar = await interaction.channel.send({
                        embeds: [new Discord.MessageEmbed()
                        .setTitle(`¿Estas seguro que quieres borrar el ticket?`)
                        .setColor("GREEN")
                        ],
                        components: [new Discord.MessageActionRow().addComponents(
                            new Discord.MessageButton().setLabel("Estoy seguro").setStyle("SUCCESS").setCustomId("Estoy seguro").setEmoji("✅")
