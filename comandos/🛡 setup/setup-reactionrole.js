                    ...
                    await idmensaje.channel.awaitMessages({
                        ...
                        if(encontrado){
                            ...
                            return message.reply({
                                embeds: [new Discord.MessageEmbed()
                                .setTitle(`✅ | **Sistema de autoroles creado.** | ✅`)
                                .setDescription(`Se ha creado un sistema de autoroles\nPara volver a crear otro sistema de autoroles simplemennte ejecuta el comando \`${prefijo}setup-reactionrole\``)
                                ]
                            })
                        } else {
